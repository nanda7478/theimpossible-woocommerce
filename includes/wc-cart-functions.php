...
function wc_add_to_cart_message( $products, $show_qty = false, $return = false ) {
	...
	if ( 'yes' === get_option( 'woocommerce_cart_redirect_after_add' ) ) {
		...
		$message = sprintf( '<a href="%s" tabindex="1" class="button wc-forward test">%s</a> %s','http://demosrvr.com/wp/theimpossibleco/ja/%E3%82%AB%E3%83%BC%E3%83%88/', esc_html__( 'View cart', 'woocommerce' ), esc_html( $added_text ) );
		}else{
