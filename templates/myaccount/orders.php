...
<?php if ( $has_orders ) : ?>
	...
	<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table my_table_orders">
		<thead>
			<tr>
			...
			<?php foreach ( $customer_orders->orders as $customer_order ) :
				...
				<tr class="woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $order->get_status() ); ?> order">
					...
					<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-order-actions">
                    		<a href="<?php bloginfo('url'); ?>/my-account/view-order/<?php echo $order->get_order_number(); ?>" class="woocommerce-button button view">View Order</a>
                    		</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
